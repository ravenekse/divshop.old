      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Edycja newsa <?php echo $news['title'] . " (ID: #" . $news['id'] . ")"; ?></h1>
          </div>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-10">
                                <?php echo($settings['demoMode'] == 0) ? form_open_multipart(base_url('panel/edit/news/save')) : '<form action="" onsubmit="event.preventDefault(); demoShowAlert()">'; ?>
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="col-lg-9 col-xl-9">
                                                <input type="text" class="form-control" name="newsTitle" value="<?php echo $news['title']; ?>">
                                              </div>
                                            </div>
                                            <div class="form-group row">
                                              ...
                                              <div class="col-lg-12 col-xl-12">
                                                <textarea name="newsContent" class="summernote"><?php echo $news['content']; ?></textarea>
                                              </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-3">
                                                    <label class="custom-switch mt-2">
                                                        ...
                                                        <input type="checkbox" name="newsActive" class="custom-switch-input" <?php echo($news['newsActive'] == 0) ? '' : 'checked'; ?>>
