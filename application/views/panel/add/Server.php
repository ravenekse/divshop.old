                    ...
                    <div class="card-body">
                        <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-10">
                                <?php echo($settings['demoMode'] == 0) ? form_open_multipart(base_url('panel/add/server/create')) : '<form action="" onsubmit="event.preventDefault(); demoShowAlert()">'; ?>
                                    <div class="row justify-content-center">
                                        <div class="col-xl-8">
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="col-6">
                                                <input type="text" class="form-control" name="serverIpAddress">
                                              </div>
                                              <div class="col-3">
                                                <input type="number" class="form-control" name="serverPort" max="65535">
                                              </div>
                                            </div>
                                            <div class="form-group row">
                                              ...
                                              <div class="col-6">
                                                <div class="input-group mb-3">
                                                    <input type="password" id="divsServerRconPass" name="serverRconPass" class="form-control">
                                              ...
                                              <div class="col-3">
                                                <input type="number" class="form-control" name="serverRconPort" max="65535">
                                              </div>
                                            </div>
                                            <div class="form-group row">
                                              ...
                                              <div class="col-3">
                                                <label class="custom-switch mt-2">
                                                  ...
                                                  <input type="checkbox" id="otherServerVersion" name="otherServerVersion" onclick="useOtherVersion();" class="custom-switch-input">
                                              ...
                                              <div class="col-3">
                                                <label class="custom-switch mt-2">
                                                  ...
                                                  <input type="checkbox" id="serverShowPort" name="serverShowPort" class="custom-switch-input">
                                                  <span class="custom-switch-indicator"></span>
                                            ...
                                            <div class="form-group row" id="otherVersionField" style="display:none;">
                                              ...
                                              <div class="col-xl-5 col-lg-6 col-9">
                                                  <input class="form-control" name="serverVersion" id="serverVersion" type="text">
                                              </div>
                                            </div>
