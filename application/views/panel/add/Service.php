    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
        <section class="section">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-10">
                                <?php echo($settings['demoMode'] == 0) ? form_open_multipart(base_url('panel/add/service/create')) : '<form action="" onsubmit="event.preventDefault(); demoShowAlert()">'; ?>
                                    <div class="row justify-content-center">
                                        <div class="col-xl-8">
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="col-lg-9 col-xl-9">
                                                <textarea name="serviceDescription" class="summernote"></textarea>
                                              </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <?php if ($settings['smsOperator'] != 0 && $settings['smsOperator'] = 1) { ?>
                                              <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                  <input type="text" class="form-control" name="serviceSmsChannel" placeholder="Przykład: MSMS.DIVSHOP">
                                                </div>
                                              </div>
                                              <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                  <input type="number" class="form-control" name="serviceSmsChannelId" placeholder="Przykład: 0987">
                                                </div>
                                              </div>
                                              <div class="form-group row">
          ...
          echo '<option value="'.$number.'">'.$number.' - '.$cost.' zł ('.getBruttoPrice($number, 1).' zł z VAT)</option>';
      } ?>
                                                  </select>
                                                </div>
                                              </div>
                                            ...
                                            <?php $paypal = json_decode($payments['paypal']['config'], true); if ($paypal['address'] != null) { ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input type="text" class="form-control" name="servicePaypalCost" placeholder="Przykład: 10.99">
                                            ...
                                            <?php $transfer = json_decode($payments['transfer']['config'], true); if (($transfer['transfer']['shopid'] && $transfer['transfer']['userid'] && $transfer['transfer']['hash']) != null) { ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input type="text" class="form-control" name="serviceTransferCost" placeholder="Przykład: 10.99">
                                                        <small>Jeżeli równa wartość np. 10 wpisz bez kropki i zer na końcu</small>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            <div class="form-group row">
                                              ...
                                              <div class="col-lg-9 col-xl-9">
                                                <textarea class="form-control" name="serviceCommands" id="serviceCommands" rows="3" style="min-height: 138px !important;max-height: 138px !important;" placeholder="Przykład: give {BUYER} apple 1; say Gracz {BUYER} dostał jabłko"></textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-3">
                                                    <label class="custom-switch mt-2">
                                                        ...
                                                        <input type="checkbox" name="serviceActive" class="custom-switch-input">
