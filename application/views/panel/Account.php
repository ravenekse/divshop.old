          ...
          <div class="row">
            <div class="col-md-10 col-sm-12 mr-auto ml-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php echo($settings['demoMode'] == 0) ? form_open_multipart(base_url('panel/account/save')) : '<form action="" onsubmit="event.preventDefault(); demoShowAlert()">'; ?>
                            <div class="tab-content" id="nav-tabContent">
                                                ...
                                                <div class="col-xl-8">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            ...
                                                            <small class="text-muted">Po zmianie nazwy zostaniesz automatycznie wylogowany(-a). Przy logowaniu użyj nowej nazwy</small>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" id="btnAddSubmit" class="btn btn-primary btn-xs mt-4"><i class="bi bi-check"></i> Zapisz</button>
                                </div>
                            </div>
