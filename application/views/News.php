<body>
    ...
    <div class="page-header header-filter header-small divshop-bg-header" data-parallax="true"
        <?php if($news['image'] != null): 
                echo 'style="background-image(' . $news['image'] . ')"';
            elseif($news['image'] == null && $settings['pageBackground'] != null):
                echo 'style="background-image(' . $settings['pageBackground'] .');"';
            elseif($news['image'] == null && $settings['pageBackground'] == null):
                echo 'style="background-image(https://cdn-n.divshop.pro/images/header.png);"';
            endif;?>>
        <div class="container">
            <div class="row">
