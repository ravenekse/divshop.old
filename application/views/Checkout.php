            ...
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto">
                    <div class="brand text-center divshop-header-shop-title">
                        <h1>DIVShop.pro - Sklep dla serwerów Minecraft</h1>
                        <h3 class="title text-center">Strona główna</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-8 col-lg-4 mr-auto ml-auto">
                    <?php if($this->uri->rsegment('1') == "checkout" && $this->uri->rsegment('2') == "processing"): ?>
                        <div class="mr-auto ml-auto mb-0 text-center">
                            ...
                            <p id="NotiflixLoadingMessage" class="loading-message">Trwa przetwarzanie płatności. Nie odświeżaj strony</p>
                        </div>
                    <?php else: ?>
                    <?php endif; ?>
                </div>
