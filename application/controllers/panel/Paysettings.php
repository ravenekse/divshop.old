...
class Paysettings extends CI_Controller
{
    ...
    public function savePayments()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            if ($this->input->post('paymentsSmsOperator') == 1) {
                $data['config'] = json_encode(['sms' => ['userid' => $this->input->post('paymentsMicrosmsUserId')]]);
            }
            ...
            $data['config'] = json_encode(['address' => (($this->input->post('paymentsPaypalAddress') == null)) ? null : $this->input->post('paymentsPaypalAddress')]);
            ...
            $data['config'] = json_encode(['transfer' => ['shopid' => $this->input->post('paymentsTransferShopId'), 'userid' => $this->input->post('paymentsTransferUserId'), 'hash' => $this->input->post('paymentsTransferHash')]]);
