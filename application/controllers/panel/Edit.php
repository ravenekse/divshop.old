...
class Edit extends CI_Controller
{
    ...
    public function serverSave()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            if ((isset($serverShowPort)) && ($serverShowPort != null)) {
                $serverShowPort = true;
            } else {
                $serverShowPort = false;
            }
    ...
    public function serviceSave()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            if ((isset($serviceActive)) && ($serviceActive != null)) {
                $serviceActive = true;
            } else {
                $serviceActive = false;
            }
    ...
    public function newsSave()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            if ((isset($newsActive)) && ($newsActive != null)) {
                $newsActive = true;
            } else {
                $newsActive = false;
            }
    ...
    public function pageSave()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            if ((isset($pageActive)) && ($pageActive != null)) {
                $pageActive = true;
            } else {
                $pageActive = false;
            }
