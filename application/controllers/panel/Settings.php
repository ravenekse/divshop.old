...
class Settings extends CI_Controller
{
    ...
    public function saveSettings()
    {
        ...
        if ($this->form_validation->run() === true) {
            ...
            if ((isset($pagePreloader)) && ($pagePreloader != null)) {
                $pagePreloader = true;
            } else {
                $pagePreloader = false;
            }
            $data['pagePreloader'] = $pagePreloader;
            if ((isset($pageEnabled)) && ($pageEnabled != null)) {
                $pageEnabled = true;
            } else {
                $pageEnabled = false;
            }
            ...
            if ((isset($pageSidebarPos)) && ($pageSidebarPos != null)) {
                $pageSidebarPos = true;
            } else {
                $pageSidebarPos = false;
            }
            ...
            if ((isset($webhookEnabled)) && ($webhookEnabled != null)) {
                $webhookEnabled = true;
            } else {
