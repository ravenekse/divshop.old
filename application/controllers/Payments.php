                            ...
                            $hookContent = json_encode([
                                ...
                                'embeds'     => [
                                    [
                                        ...
                                        'type'        => 'rich',
                                        'description' => str_replace(['{buyer}', '{BUYER}'], $nickName, str_replace(['{service}', '{SERVICE}'], $serviceName, $settings['shopDiscordWebhookDesc'])),
                                        'timestamp'   => date('c'),
                            ...
                            $hookContent = json_encode([
                                ...
                                'embeds'     => [
                                    [
                                        'title'       => $settings['shopDiscordWebhookEmbedTitle'],
                                        'type'        => 'rich',
                                        'description' => str_replace(['{buyer}', '{BUYER}'], $payment['buyer'], str_replace(['{service}', '{SERVICE}'], $service['name'], $settings['shopDiscordWebhookDesc'])),
                                        'timestamp'   => date('c'),
                                        'color'       => hexdec($settings['shopDiscordWebhookHex']),
                                        'footer'      => [
                                            'text' => 'DIVShop.pro',
                        ...
                        $hookContent = json_encode([
                            ...
                            'embeds'     => [
                                [
                                    'title'       => $settings['shopDiscordWebhookEmbedTitle'],
                                    'type'        => 'rich',
                                    'description' => str_replace(['{buyer}', '{BUYER}'], $transferData['buyer'], str_replace(['{service}', '{SERVICE}'], $service['name'], $settings['shopDiscordWebhookDesc'])),
                                    'timestamp'   => date('c'),
                                    'color'       => hexdec($settings['shopDiscordWebhookHex']),
                                    'footer'      => [
                                        'text' => 'DIVShop.pro',
