...
class PurchasesM extends CI_Model
{
    private $db_table = 'divs_purchases';
    ...
    {
        $result = $this->db->where($column, $data)->order_by('id', 'DESC')->limit(48)->get($this->db_table)->result_array();
        if ($result == null) {
            return null;
    ...
    public function getLastFive($start = 0, $limit = '5')
    {
